...
class Fibronectins:
    ...
    def __init__(self):
        ...
        self.side_lengthx = 150
        self.side_lengthy = 150
        self.side_lengthz = 150
        self.timestep = 0.008
        ...
        self.loop_epsilon = 1
        self.rod_spacing = 3.35
        self.patch_diameter = 1.0

        # sets the interaction between the attractive patches
        # separated into inner (i) and outer (o)
        self.hydrogen_bond_epsilon_ii = 3 #inner-inner
        self.hydrogen_bond_epsilon_oo = 2.25 #outer-outer
        self.hydrogen_bond_epsilon_io = 1.5 #inner-outer
        self.hydrogen_bond_cutoff = 1.3
