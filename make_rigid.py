...
class Fibronectins:
    ...
    def __init__(self):
        ...
        self.side_lengthx = self.side_lengthy = self.side_lengthz = 100
        self.no_rods = 5
    ...
    def make_rigid_monomer(self,x,y,z):
        ...
        for i in range(self.no_rods):
            ...
            for j in range(self.beads_per_rod):
                ...
                self.atoms.append((self.atomic_index,self.molecular_index,1,0,i*self.no_rods,j*self.bead_spacing))
...
fibronectins.make_rigid_monomer(0,0,0)